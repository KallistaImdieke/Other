...
FUNCTION global_dialog(dialog_name)
	IF dialog_name = "CASE NUMBER DIALOG" THEN
		BeginDialog dialog_name, 0, 0, 181, 120, "Case number dialog"
		...
		EndDialog
	ELSEIF dialog_name = "CAF DIALOG 01" THEN
		BeginDialog dialog_name, 0, 0, 451, 260, "CAF Part 1"
		...
		EndDialog
	ELSEIF dialog_name = "CAF DIALOG 02" THEN
		BeginDialog dialog_name, 0, 0, 451, 315, "CAF Part 2"
		...
		EndDialog
	ELSEIF dialog_name = "CAF DIALOG 03" THEN
		BeginDialog dialog_name, 0, 0, 451, 355, "CAF dialog part 3"
		...
		EndDialog
	ELSE
		MsgBox "You attempted to call a dialog that does not exist."
	END IF
